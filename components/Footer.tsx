...
const Footer = ({ isSidebarOpen = false }: FooterProps) => {
  ...
  return (
    <footer className="bg-white border-t border-slate-100 py-12 px-8 w-full transition-all duration-300">
      {/* We use a flex container that fills the width.
          Inside the dashboard, we rely on the ProfileLayout's margin to position us.
      */}
